 ...
 def main():
     ...
     st.markdown(
         ...
         .stTextInput > div > div > input {
             border: 3px solid #870F26; /* Bold border for the text input */
         }
         /* For the prompt chat input specifically */
         div[data-testid="stChatInput"] div[data-testid="stTextInput"] div[data-testid="stForm"] > div > div > input {
            border: 3px solid #870F26 !important; /* Specific bold border for chat input */
         }
         </style>
         """,
